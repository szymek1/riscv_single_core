...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.instruction_fetch_bram xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.instruction_fetch_bram -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/szymon/Documents/ISAE/research_project/implemnetations/riscv_single_core/rv32i_sc.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log instruction_fetch_bram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
