...
#
# Script generated by Vivado on Sat Jun 07 19:28:17 CEST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : instruction_fetch_bram.sh
...
#
# Usage        : instruction_fetch_bram.sh
#                instruction_fetch_bram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                instruction_fetch_bram.sh [-reset_run]
#                instruction_fetch_bram.sh [-reset_log]
#                instruction_fetch_bram.sh [-help]
#
...
#                script (type 'instruction_fetch_bram.sh -help' for more information).
#
...
# script info
echo -e "instruction_fetch_bram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./instruction_fetch_bram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.instruction_fetch_bram xil_defaultlib.glbl -o instruction_fetch_bram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./instruction_fetch_bram_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/szymon/Documents/ISAE/research_project/implemnetations/riscv_single_core/rv32i_sc.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key instruction_fetch_bram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc instruction_fetch_bram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./instruction_fetch_bram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: instruction_fetch_bram.sh [-help]\n\
Usage: instruction_fetch_bram.sh [-step]\n\
Usage: instruction_fetch_bram.sh [-lib_map_path]\n\
Usage: instruction_fetch_bram.sh [-reset_run]\n\
Usage: instruction_fetch_bram.sh [-reset_log]\n\
Usage: instruction_fetch_bram.sh [-keep_index]\n\
Usage: instruction_fetch_bram.sh [-noclean_files]\n\n\
